...
class Solver(BaseSolver):
    ...
    def fetch_data(self, data):
        ...
        #===========================TODO==========================
        # Move data to device and compute text seq. length
        # txt_len = length of the text sequence excluding padding tokens (non-zero tokens)
    ...
    def set_model(self):
        ...
        # Losses
        #===========================TODO==========================
        # defien seq_loss and ctc_loss
        # use torch.nn.CrossEntropyLoss to implement self.seq_loss, with ignore_index=0
        # use torch.nn.CTCLoss to implement self.ctc_loss, with blank=0, zero_infinity=False
