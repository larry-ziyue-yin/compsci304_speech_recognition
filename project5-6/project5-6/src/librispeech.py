...
class LibriDataset(Dataset):
    def __init__(self, path, split, tokenizer, bucket_size, ascending=False):
        # Setup
        #print(path)#/home/nas2/ecg/23_licancan/dataset/aishell/data_aishell/wav
        self.path = path
        ...
        for s in split:
            ...
            #print(file_list) #/home/nas2/ecg/23_licancan/dataset/aishell/data_aishell/wav/dev/S0763/BAC009S0763W0495.wav
        # Read text
