...
def collect_audio_batch(batch, audio_transform, mode):
    ...
    with torch.no_grad():
        for b in batch:
            #======================TODO=========================
            # get file(file name),audio_feat,audio_len,text from b
            # hint: use audio_transform function to extract feat
    ...
    # Zero-padding
    #======================TODO=========================
    # pad audio_feat and text according to the longest length. You can use pad_sequence
