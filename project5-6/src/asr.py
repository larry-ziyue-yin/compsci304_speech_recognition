...
class ASR(nn.Module):
    ...
    def forward(self, audio_feature, feature_len, decode_step, tf_rate=0.0, teacher=None,
        ...
        # Encode
        #======================TODO=========================
        # use encoder to encode the audio features into encode features
        # input: audio_feature, feature_len
        # output: encode_feature, encode_len

        #===================================================

        # CTC based decoding
        #======================TODO=========================
        # if ctc is enabled, implement the ouput of ctc using log_softmax with ctc_layer
        # input: encode_feature
        # output: ctc_output
