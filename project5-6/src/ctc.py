...
class CTCPrefixScore():
    ...
    def init_state(self):
        ...
        for i in range(1, self.input_length):
            # ========TODO: Accumulate Blank Probabilities =============
            # Implement accumulation of blank symbol probabilities
            # Hint: Blank probability at each step is the sum of previous blank probability 
            # and current blank probability from CTC output
            # r[i, 1] = ??
            # ====================================
        return r
    ...
    def full_compute(self, g, r_prev):
        ...
        for t in range(start, self.input_length):
            ...
            # ========TODO: Calculate Non-Blank Symbol Probability ==========
            # P(h|current step is non-blank) = [ P(prev. step = y) + P()]*P(c)
            # r[t, 0, :] = ??
            # ====================================

             # ========TODO: Calculate Blank Symbol Probability =============
...
class CTCBeamDecoder(nn.Module):
    ...
    def forward(self, feat, feat_len):
        ...
        for t in range(T):
            ...
            for i in range(len(B)): # For y in B
                ...
                if B_i_new.get_len() > 0: # If y is not empty
                    if B_i_new.y[-1] == 1:
                        ...
                        continue
                    # ========TODO Update Non-Blank Symbol Probabilities =============
                    # Please update the probability that the sequence ends with the same non-blank symbol
                    # Hint: Use the update_Pr_nblank() method
                    ...
                    for j in range(len(B)):
                        if i != j and B[j].check_same(B_i_new.y[:-1]):
                            ...
                            # ========TODO 17: Prefix Expansion Probabilities =============
                            # Please handle the case of prefix expansion
                            # Hint: Use the update_Pr_nblank_prefix() method
                ...
                for j in range(self.vocab_cand):
                    ...
                    # ========TODO Add New Symbol =============
                    # Please add new symbol to the sequence
                    # Hint: Use the add_token() method
            ...
            # Please implement sequence deduplication functionality
            # Hint: sort by string 
